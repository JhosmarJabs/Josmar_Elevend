namespace view {
    export class vistaUsuarios {
        ...
        private controllerDelete = new controller.eliminacion();
        ...
        private eliminarPersonaPU(user: entidades.IPersona) {
            ...
            this.controllerDelete.mostrarConfirmacion(user.nombre,
                (confirmar: boolean) => {
                    if (confirmar) {
                ...
                .join(
                    enter => {
                        ...
                        acciones.append("button")
                            ...
                            .style("font-size", "18px")
                            .style("cursor", "pointer")
                            .on("click", (_, d: entidades.IPersona) => this.eliminarPersonaPU(d));
        ...
        private crearVentanaPrincipal(): void {
            this.ventanaPadre = this.windowController.createWindow("Usuarios", null);
            this.agregarContenidoVentana();
        }

        private agregarContenidoVentana(): void {
